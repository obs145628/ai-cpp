...
public:
    ...
    ShellCanvas(const ShellCanvas&) = delete;
    ShellCanvas(ShellCanvas&&) = delete;
    ShellCanvas& operator=(const ShellCanvas&) = delete;
    ShellCanvas& operator=(ShellCanvas&&) = delete;
    ~ShellCanvas();
